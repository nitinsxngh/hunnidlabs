...
interface ProjectDetailRightProps {
  projectName: string;
...
const ProjectDetailRight: React.FC<ProjectDetailRightProps> = ({
  projectName,
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-8 py-24">
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center lg:grid-flow-dense">
          {/* Left Section - Overlapping Cards (appears first in DOM but positioned on left) */}
          <motion.div
            initial={{ opacity: 0, x: -30 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="relative h-[500px] flex items-center justify-center lg:col-start-1 lg:row-start-1"
          >
            {/* Back Rectangle */}
            <motion.div
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="space-y-8 lg:col-start-2"
          >
            {/* Small Heading */}
            <p 
